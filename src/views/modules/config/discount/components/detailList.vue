        ...
        <el-table-column :width="60" label="操作" type="action" align="center">
          <template slot-scope="scope">
            <el-row type="flex" justify="space-around" class="font-16">
              <el-button type="text" :disabled="disabled" icon="el-icon-edit" @click.stop="edit(scope.row)">
              </el-button>
              <el-button type="text" :disabled="disabled" icon="el-icon-delete" class="font-red" @click.stop="del(scope.row)">
              </el-button>
            </el-row>
          </template>
        </el-table-column>
